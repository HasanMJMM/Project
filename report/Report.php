      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <button type="submit" class="btn btn-block"
            style="background-color: #000032; color: white; padding: 6px 8px; text-align: center; text-decoration: none; display: inline-block; font-size: 14px; margin: 0 2px 10px; cursor: pointer; border-radius: 6px;"
            name="generate">Generate Report</button>
        </div>
      </div>
    </div>
