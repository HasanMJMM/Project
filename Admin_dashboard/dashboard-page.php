                ...
                <div class="col-md-4 pb-5">
                    <div class="card shadow text-center custom-card">
                        <div class="card-body">
                            ...
                            <a href="bus_registration.php" class="btn btn-primary"> Add Bus</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card shadow text-center custom-card">
                        <div class="card-body">
                            <img src="images/Admin/Add_employee.jpg" alt="Image" class="card-image"
                                style="width: 130px;">
                ...
                <div class="col-md-4">
                    <div class="card shadow text-center custom-card">
                        <div class="card-body">
                            ...
                            <a href="../report/Report.php" class="btn btn-primary update-button">Report Generate</a>
                        </div>
                    </div>
                </div>
